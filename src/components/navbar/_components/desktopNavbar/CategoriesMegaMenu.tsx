                            ...
                            <ul className="space-y-0.5">
                                {data?.map((cat) => (
                                    <Link
                                        ...
                                        className="px-4 py-2.5 cursor-pointer flex justify-between items-center transition-all duration-200 hover:bg-green-50 group"
                                    >
                                        <span className="text-gray-700 group-hover:text-green-600 font-medium text-sm">
                                            {cat.name}
                                        </span>
                                        <Image
