...
import { fetchCategoryByIdHome1, fetchProductsByCategoryHome1, fetchSubCategoriesHome1 } from "@/rtk/slices/home/homeSlice1";
...
const FilterTabs = () => {
  ...
  /* Subcategories */
  const { category, subCategories, products, loading } = useAppSelector((s) => s.home1);
